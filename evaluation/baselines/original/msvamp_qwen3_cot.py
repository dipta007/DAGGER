# ============================================================
# MSVAMP Bangla Evaluation with reasoning model
# - checkpointing
# - token usage stats
# ============================================================
...
model_name = "unsloth/Qwen3-4B"   # full 16-bit Qwen3-8B via Unsloth
...
def run_msvamp_bn(
    split="test",
    max_samples=None,
    checkpoint="msvamp_qwen3_4b_checkpoint.json",
    out_json="msvamp_qwen3_4b_detailed.json",
    out_csv="msvamp_qwen3_4b_summary.csv",
    max_new_tokens=7168
):
